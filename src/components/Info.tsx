  ...
  return (
    ...
    <IonContent>
      ...
      <div className="info-container">
        ...
        <strong><p>Emoji itne-areye Australia mpwepe-arenye. itne ayeye
          ...
          rlterrke-aneme-akwete. </p></strong>

        <p>This emoji sticker set represents life, culture and language on
          ...
          them realise their ideas.</p>

        <p> Each emoji has an Arrernte name, the ancient language of our
          ...
          keep our language strong.</p>

        {/* onClick launch modal/slide component? */}
        <p onClick={() => { setIsOpen(true) }} id="slide-link"> View the welcome screens. </p>

        <p> Read more about the emojis on the </p>
        <a href="https://www.indigemoji.com.au/">Indigemoji website</a>.
        <br />
        <p>
          <a href="https://www.indigemoji.com.au/terms-conditions"> View terms and conditions of use.</a>
        </p>
