        ...
        >
          ...
          <SwiperSlide>
            <IonGrid>
              <IonRow>
                <IonCol>
                  <IonImg src="../assets/welcome/welcomescreen1.jpg" id="slide-img" />
                </IonCol>
                <IonCol>
          ...
          <SwiperSlide>
            <IonGrid>
              <IonRow>
                <IonCol>
                  <IonImg src="../assets/welcome/map_rounded.jpg" id="slide-img" />
                </IonCol>
                <IonCol>
                  <div className="slide-container">
          ...
          <SwiperSlide>
            <IonGrid>
              <IonRow>
                <IonCol>
                  <IonImg src="../assets/welcome/photo_rounded.jpg" id="slide-img" />
                </IonCol>
                <IonCol>
                  <div className="slide-container">
                    <strong>
          ...
          <SwiperSlide>
            ...
            <IonRow>
              <IonCol>
                <IonImg src="../assets/welcome/screenshot_rounded.jpg" id="slide-img" />
              </IonCol>
              <IonCol>
                <div className="slide-container">
          ...
          <SwiperSlide>
            ...
            <IonRow>
              <IonCol>
                <IonImg src="../assets/welcome/talk_rounded.jpg" id="slide-img" />
              </IonCol>
              <IonCol>
                <div className="slide-container">
