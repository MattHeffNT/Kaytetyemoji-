                ...
                <IonSlides pager={true} options={slideOpts}>
                    ...
                    <IonSlide>
                        <div className="slide-container">
                            ...
                            <strong>
                                <p>
                                    Unte apeke emoji renhe yernetyeke, app
                                    nhenhe altywere-ilaye, kele emoji unte
                                    ahentye-aneme uthemele, kele imernte
                                    antherreme-kenhe-button ulthemele.
                                </p>
                            </strong>
                            <p>
                                To share an emoji sticker, just open this app,
                                select the sticker you want to use and then tap
                                the share button. You can then choose which
                    ...
                    <IonSlide>
                        <div className="slide-container">
                            ...
                            <h1>Awaye!</h1>
                            <p>
                                New audio! Press the play button to learn to
                                pronounce the Arrernte emojis
                            </p>
                        </div>
                    </IonSlide>
                </IonSlides>
